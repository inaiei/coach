...
import useMacroProportions, { handSizeRatios, macroColors } from "../../Hooks/useMacroProportions";
...
const MacroProtions = () => {
  ...
  const { proteinGms, carbsGms, fatGms, proteinHandSize, carbsHandSize, fatHandSize } = useMacroProportions(globalState.userProfile);
  ...
  return (
      <Grid container spacing={2}>
        ...
        <MacroResultVeggies macroColors={macroColors} veggiesHandSize={handSizeRatios.veggies}/>
